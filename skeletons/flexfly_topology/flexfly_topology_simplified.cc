...
namespace hw {
 ...
 flexfly_topology_simplified::flexfly_topology_simplified(sprockit::sim_parameters* params) : 
 	...
 	std::cout << "FLEXFLY_TOPOLOGY_SIMPLIFIED" << std::endl;
...
bool flexfly_topology_simplified::switch_id_slot_filled(switch_id sid) const {
  ...
  */
   ...
   **/
  void flexfly_topology_simplified::route_minimal(int src_switch, int dst_switch, flexfly_packet* f_packet) {
   ...
   **/
  void flexfly_topology_simplified::optical_switch_update_inout(int optical_swid, std::vector<int>& inout_configuration) {
   ...
   **/
  void flexfly_topology_simplified::configure_optical_switches_general(std::vector<std::vector<int>>& connectivity_requirement,
...
/**
   ...
   * Note: unordered_map will have to be initialized by the caller
   **/
  void flexfly_topology_simplified::configure_optical_switches_general3(std::vector<std::vector<int>>& connectivity_requirement,
                                                            std::unordered_map<int, std::vector<int>>& optical_switch_inout_config) {
    /**********************************************************************************************************
    ******************************** WORKING SECTION **********************************************************
    **********************************************************************************************************/
  ...
  **********************************************************************************************************/
  ...
  bool flexfly_topology_simplified::delete_item(std::vector<int>& set, int optical_switch) {
    bool to_ret = false;
    int i;
  ...
  void flexfly_topology_simplified::add_item(std::vector<int>& set, int optical_switch) {
    if (std::find(set.begin(), set.end(), optical_switch) == set.end()) 
      set.insert(set.end(), optical_switch);
  };

  int flexfly_topology_simplified::remaining_row_requirement(std::vector<int>& comm_requirement) {
    int requirement = 0;
  ...
  int flexfly_topology_simplified::union_set_size(std::vector<std::vector<int>>& group_connectivity_vector, int start, int end) {
  ...
  bool flexfly_topology_simplified::check_remaining(std::vector<std::vector<int>>& group_connectivity_vector, std::vector<int>& requirement) {
    bool result = true;
   ...
   * Note: unordered_map will have to be initialized by the caller
   **/
  void flexfly_topology_simplified::configure_optical_switches_general4(std::vector<std::vector<int>>& connectivity_requirement,
                                                            std::unordered_map<int, std::vector<int>>& optical_switch_inout_config) {
    /**********************************************************************************************************
    ******************************** WORKING SECTION **********************************************************
    **********************************************************************************************************/
